...
const Profile = () =>{
    ...
    const profileEdit = (e) =>{
        e.preventDefault();
        console.log(`${username} - ${organization} - ${email} - ${imageurl} - ${type}`)
    }
        ...
        <div className='container-fluid pb-5'>
            <div className='row'>
                    ...
                    <div className='col pt-4'>
                        <button className='btn btn-light' id="header-button">Log out</button>
                    </div>
                    <div className='col pt-4'>
                    ...
                    <div className='col' >
                        <div className='container-fluid' >
                                ...
                                <div className='row' id='form-container'>
                                    <div className='col'>
                                        <div className='container-fluid p-5 rounded' id='profile-detail-section'>
                                            <form onSubmit={profileEdit}>
                                                    ...
                                                    <div class="form-group">
                                                        <div className='form-outline'>
                                                                ...
                                                                <input type="email" id='useremail' className='form-control' onChange={event => setEmail(event.target.value)}/>
                                                        </div>
                                                        </div>
                                                        ...
                                                        <div className='form-outline'>
                                                                ...
                                                                <input type="text" className='form-control' onChange={event => setOrganization(event.target.value)}/>
                                                        </div>
                                                        </div>
                                                        <div className='form-outline'>
                                                            
                                                                <label className='form-label'>Type</label>
                                                                <select name="typeoforg" id="type" className='form-control' onChange={event => setType(event.target.value)}>
                                                        ...
                                                        <div class="form-group">
                                                        <div className='form-outline'>
                                                            <label for='inputimage' className='form-label'>Profile Image</label>  <br />   
                                                            <img src={imageurl} width="150px" />
                                                            <input id='inputimage' type="file" className='form-control mt-3' onChange={event => setImageurl(event.target.value)}/>
                                                            <input id='inputimage' type="text" className='form-control mt-3' placeholder='Image URL' onChange={event => setImageurl(event.target.value)}/>
                                                        </div>
                                                    </div>
